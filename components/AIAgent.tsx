...
import { searchSimilarCases, getCasesFromSupabase } from '../utils/supabase';
import { generateResponseWithRAG } from '../utils/aiAgent';
...
const AIAgent: React.FC<AIAgentProps> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-red-50/20 to-stone-100 flex flex-col">
      {/* Header */}
      ...
      {/* Quick Questions */}
      {messages.length === 1 && (
        <div className="px-4 py-4 bg-white/50 border-t border-stone-200">
