              ...
              {viewMode === 'list' ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-ink-medium mb-1">👈 左滑选项</label>
                      <input
                        type="text"
                        className="w-full p-2 border-b-2 border-ink-light bg-transparent focus:outline-none focus:border-ink rounded-md text-sm"
                        value={randomEventFormData.options.left.text}
                        onChange={(e) =>
                          setRandomEventFormData({
                            ...randomEventFormData,
                            options: {
                              ...randomEventFormData.options,
                              left: { ...randomEventFormData.options.left, text: e.target.value },
                            },
                          })
                        }
                      />
                      <div className="mt-2 grid grid-cols-2 gap-2 text-[11px] text-ink-medium">
                        {(['economy', 'people', 'environment', 'governance'] as const).map((k) => (
                          <label key={k} className="flex items-center gap-1">
                            <span className="w-16 capitalize">{k}</span>
                            <input
                              type="number"
                              className="flex-1 p-1 border border-ink-light rounded"
                              value={randomEventFormData.options.left.delta[k] || 0}
                              onChange={(e) => {
                                ...
                                setRandomEventFormData({
                                  ...
                                  options: {
                                    ...randomEventFormData.options,
                                    left: {
                                      ...randomEventFormData.options.left,
                                      delta: { ...randomEventFormData.options.left.delta, [k]: isNaN(v) ? 0 : v },
                                    },
                                  },
                                });
                              }}
                    ...
                    <div>
                      <label className="block text-xs font-bold text-ink-medium mb-1">👉 右滑选项</label>
                      <input
                        type="text"
                        className="w-full p-2 border-b-2 border-ink-light bg-transparent focus:outline-none focus:border-ink rounded-md text-sm"
                        value={randomEventFormData.options.right.text}
                        onChange={(e) =>
                          setRandomEventFormData({
                            ...randomEventFormData,
                            options: {
                              ...randomEventFormData.options,
                              right: { ...randomEventFormData.options.right, text: e.target.value },
                            },
                          })
                        }
                      />
                        ...
                        {(['economy', 'people', 'environment', 'governance'] as const).map((k) => (
                          <label key={k} className="flex items-center gap-1">
                            ...
                            <input
                              type="number"
                              className="flex-1 p-1 border border-ink-light rounded"
                              value={randomEventFormData.options.right.delta[k] || 0}
                              onChange={(e) => {
                                const v = parseInt(e.target.value || '0', 10);
                                setRandomEventFormData({
                                  ...randomEventFormData,
                                  options: {
                                    ...randomEventFormData.options,
                                    right: {
                                      ...randomEventFormData.options.right,
                                      delta: { ...randomEventFormData.options.right.delta, [k]: isNaN(v) ? 0 : v },
                                    },
                                  },
                                });
                              }}
