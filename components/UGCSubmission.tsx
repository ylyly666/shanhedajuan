...
import { saveCaseToSupabase, generateEmbedding } from '../utils/supabase';
import { extractCaseFromText } from '../utils/caseExtractor';
import { StatKey, CaseSource, KnowledgeBaseCase, AIExtractedCase } from '../types';
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-6 rounded-lg">
          <p className="text-sm text-blue-800">
            💡 <strong>分享您的真实经验</strong>：提交您在基层工作中遇到的真实案例。审核通过后，将用于训练AI智能体并扩充知识库，帮助更多基层工作者。
          </p>
        </div>
